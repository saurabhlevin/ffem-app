...
public class AnalyzeDetailFragment extends Fragment {
     ...
     */
    public AnalyzeDetailFragment() {
    }

    public static AnalyzeDetailFragment newInstance(ResultInfo resultInfo) {
...
//        AddImage(layoutImages, resultInfo.endImage);
        ...
        AddText(layoutResult, String.format("%s, %s, %s", resultInfo.volume,
                toTitleCase(resultInfo.media), resultInfo.testType));
