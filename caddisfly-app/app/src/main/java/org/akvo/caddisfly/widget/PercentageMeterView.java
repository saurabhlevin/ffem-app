...
/**
 * Meter widget to displaying bars from red to green denoting quality
 */
public class PercentageMeterView extends View {
    ...
    private int[][] colours = {{230, 53, 46}, {234, 91, 47}, {240, 132, 45},
            {232, 168, 52}, {247, 211, 43}, {212, 216, 57}, {169, 204, 57},
