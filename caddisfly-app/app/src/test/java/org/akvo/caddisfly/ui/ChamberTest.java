...
public class ChamberTest {
    ...
    public void testCount() throws Exception {
        ...
        assertSame(1, listView.getCount());
        assertEquals("Water - Chromium",
                ((TestInfo) listView.getAdapter().getItem(0)).getName());
        assertEquals("Water - Chromium",
    ...
    public void clickTest() {
        ...
        assertTrue(list.performItemClick(0));
    ...
    public void textExternalWithoutPermission() {
        ...
        data.putString(CADDISFLY_RESOURCE_ID, SensorConstants.CHROMIUM_ID);
        data.putString(CADDISFLY_QUESTION_ID, "123");
        data.putString(CADDISFLY_QUESTION_TITLE, "Chromium");
    ...
    private void testExternalActivity(boolean setCalibration) {
        ...
        if (setCalibration) {
            ...
            Button button = activity.findViewById(R.id.buttonDilution1);
            button.performClick();

            Intent nextIntent = shadowOf(activity).getNextStartedActivity();
            if (nextIntent.getComponent() != null) {
                assertEquals(ColorimetryLiquidActivity.class.getCanonicalName(),
